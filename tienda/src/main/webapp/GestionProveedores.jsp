...
<nav id="navprin"> <br> <br> <br><br> <br></nav>
    ...
    <e>---------GESTION DE PROVEEDORES TIENDA DOÑA GALLINA---------</e><!--elementos de la lista-->
    ...
    <hr>
     <div>
         ...
         <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal"> Registrar Proveedor </button>
         
         <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal2"> Actualizar Proveedor </button>         
        
         <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal3"> Eliminar Proveedor  </button>
     ...
     <!-- contenido de la pagina -->
      ...
      <table id="tabla" class="display" style="width:100%">
        ...
        <tr>
            ...
            <th>Nombre</th>
            <th>Telefono</th>
            <th > <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"> Agregar Proveedor </button> </th>
  ...
  <div class="modal-dialog">
    ...
    <!--etiqueta con multiples atributos-->
     <!--place holder le da nombre a o instructivo a la cajita-->
        <input type="text" class ="inputs" id ="input1" name ="inputUser" placeholder="Nit">
        <!--enmascaramiento-->
        <input type="text" class ="inputs" id ="input2" name ="inputPassword" placeholder="Ciudad"> <!--convencion camel case igual que java-->
        <input type="text" class ="inputs" id ="input3" name ="inputUser" placeholder="Direccion">
     ...
     <!--  <input type="submit" name ="login" id ="CrearUsuario" class ="button" value ="REGISTRAR USUARIO">-->
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id ="crearProveedor">Crear Proveedor</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog">
    ...
    <!--etiqueta con multiples atributos-->
     <!--place holder le da nombre a o instructivo a la cajita-->
        ...
        <!--enmascaramiento-->
        <input type="text" class ="inputs" id ="input22" name ="inputPassword" placeholder="Ciudad"> <!--convencion camel case igual que java-->
        <input type="text" class ="inputs" id ="input33" name ="inputUser" placeholder="Direccion">
     ...
     <!--  <input type="submit" name ="login" id ="CrearUsuario" class ="button" value ="REGISTRAR USUARIO">-->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
        <button type="submit" class="btn btn-primary" id ="ActualizarProveedor">Actualizar Proveedor</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <!--etiqueta con multiples atributos-->
     <!--place holder le da nombre a o instructivo a la cajita-->
        <input type="text" class ="inputs" id ="input111" name ="inputCedula" placeholder="Nit">
        <hr>
        <!--enmascaramiento-->
        <input type="text" class ="inputs" id ="input222" name ="inputPassword" placeholder="Ciudad"> <!--convencion camel case igual que java-->
        <input type="text" class ="inputs" id ="input333" name ="inputUser" placeholder="Direccion">
     ...
     <!--  <input type="submit" name ="login" id ="CrearUsuario" class ="button" value ="REGISTRAR USUARIO">-->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
        <button type="submit" class="btn btn-primary" id ="ActualizarProveedor2">Actualizar Proveedor</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel3">Eliminar Proveedor</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="">
    ...
    <!--etiqueta con multiples atributos-->
     <!--place holder le da nombre a o instructivo a la cajita-->
        <input type="text" class ="inputs" id ="input0" name ="inputNit" placeholder="Nit a Eliminar">
        <hr>
          <!--cargar archivo Usuario-->
     ...
     <!--  <input type="submit" name ="login" id ="CrearUsuario" class ="button" value ="REGISTRAR USUARIO">-->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
        <button type="submit" class="btn btn-primary" id ="EliminarProveedor">Eliminar Proveedor</button>
      </div>
    </div>
  </div>
</div>
