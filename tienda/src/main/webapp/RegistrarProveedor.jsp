...
<!--http://localhost:8080/RegistrarProveedor.jsp-->
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <e>---------REGISTRAR PROVEEDOR---------</e><!--elementos de la lista-->
    <hr>
    <ul>
    ...
    <hr>
     <form action="">
        ...
        <input type="number" class ="inputs" id ="input1" name ="inputNit" placeholder="Nit">
        
         <input type="text" class ="inputs" id ="input2" name ="inputCiudad" placeholder="Ciudad">
        
        <input type="text" class ="inputs" id ="input3" name ="inputDireccion" placeholder="Direccion">
        ...
        <input type="submit" name ="create" id ="crearProveedor" class ="button" value ="REGISTRAR">
    </form>
