...
%>
  ...
  ---------GESTION DE USUARIOS TIENDA DOÑA GALLINA---------
  <hr>
  ...
  <div>
         ...
         <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal"> Registrar Usuario </button>
         
         <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal2"> Actualizar Usuario </button>         
        
         <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal3"> Eliminar Usuario </button>
  ...
  <div class="modal-dialog">
    ...
    <!--etiqueta con multiples atributos-->
     <!--place holder le da nombre a o instructivo a la cajita-->
        ...
        <!--enmascaramiento-->
        <input type="text" class ="inputs" id ="input22" name ="inputPassword" placeholder="Nombre Completo"> <!--convencion camel case igual que java-->
        <input type="email" class ="inputs" id ="input33" name ="inputUser" placeholder="Correo Electronico">
        <input type="text" class ="inputs" id ="input44" name ="inputUser" placeholder="Usuario">
        <input type="password" class ="inputs" id ="input55" name ="inputUser" placeholder="Contraseña">
        <!--cargar archivo Usuario-->
     ...
     <!--  <input type="submit" name ="login" id ="CrearUsuario" class ="button" value ="REGISTRAR USUARIO">-->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
        <button type="submit" class="btn btn-primary" id ="ActualizarUsuario">Actualizar Usuario</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <!--etiqueta con multiples atributos-->
     <!--place holder le da nombre a o instructivo a la cajita-->
        <input type="number" class ="inputs" id ="input111" name ="inputCedula" placeholder="Cedula a actualizar" required>
        <hr>
        <!--enmascaramiento-->
        <input type="text" class ="inputs" id ="input222" name ="inputPassword" placeholder="Nombre Completo"> <!--convencion camel case igual que java-->
        <input type="email" class ="inputs" id ="input333" name ="inputUser" placeholder="Correo Electronico">
        <input type="text" class ="inputs" id ="input444" name ="inputUser" placeholder="Usuario">
        <input type="password" class ="inputs" id ="input555" name ="inputUser" placeholder="Contraseña">
        <!--cargar archivo Usuario-->
     ...
     <!--  <input type="submit" name ="login" id ="CrearUsuario" class ="button" value ="REGISTRAR USUARIO">-->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
        <button type="submit" class="btn btn-primary" id ="ActualizarUsuario2">Actualizar Usuario</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel3">Eliminar Usuario</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="">
    ...
    <!--etiqueta con multiples atributos-->
     <!--place holder le da nombre a o instructivo a la cajita-->
        <input type="number" class ="inputs" id ="input0" name ="inputCedula" placeholder="Cedula a Eliminar" >
        <hr>
          <!--cargar archivo Usuario-->
     ...
     <!--  <input type="submit" name ="login" id ="CrearUsuario" class ="button" value ="REGISTRAR USUARIO">-->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
        <button type="submit" class="btn btn-primary" id ="EliminarUsuario">Eliminar Usuario</button>
      </div>
    </div>
  </div>
</div>
    ...
    <script src="scripts/table.js"></script></body>
</html>
