...
%>
    <e>---------GESTION DE USUARIOS TIENDA DOÑA GALLINA---------</e><!--elementos de la lista-->
      
    <hr>
     <ul>
     
        <li><a href="RegistrarUsuario.jsp">Registrar</a></li><!--elementos de la lista-->
        <li><a href="ListarUsuario.jsp">Buscar</a></li>
         <li><a href="ActualizarUsuario.jsp">Actualizar</a></li>
         <li><a href="ListarUsuario.jsp">Eliminar</a></li>
